...
public class ReadCSV {
	...
	//public ReadCSV(String fileName, Boolean debugMode, String startDateStr, String endDateStr, int optionVal) throws Exception {
	public ReadCSV(ReadConfig config, String startDateStr, String endDateStr, int optionVal) throws Exception {
		...
		if (config.debugMode){
			System.out.println("startDateStr endDateStr: " + sdf.format(startDate) + " " + sdf.format(endDate));
		}
